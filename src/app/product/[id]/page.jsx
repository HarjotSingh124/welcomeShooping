  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        {/* Left: Images */}
        <div>
          <div className="relative w-full h-[480px] bg-white border rounded-xl shadow overflow-hidden">
            <Image
            ...
            {(product.images || []).map((img, idx) => (
              <button
                ...
                className={`w-20 h-20 rounded-md overflow-hidden border ${
                  activeImage === img ? "ring-2 ring-[#BEB9B1]" : ""
                }`}
              >
                <Image
                  src={img}
              ...
              <div className="flex items-center text-yellow-500">
                {Array.from({ length: 5 }).map((_, i) => (
                  <Star
                    key={i}
                    size={18}
                    className={i < Math.floor(avgRating) ? "fill-yellow-500" : "text-gray-300"}
                  />
                ))}
          ...
          {(product.stock === null || product.stock > 0) && (
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-6 py-3 bg-yellow-400 hover:bg-yellow-500 text-black font-semibold rounded-lg shadow"
              >
                Add to cart
              </button>
              <button
                onClick={handleBuyNow}
                className="px-6 py-3 bg-[#BEB9B1] hover:opacity-90 text-white font-semibold rounded-lg shadow"
              >
                Buy now
              </button>
            </div>
            ...
            <>
                    ...
                    <div className="flex text-yellow-500">
                      {Array.from({ length: 5 }).map((_, i) => (
                        <Star
                          ...
                          size={14}
                          className={
                            i < (r.rating || 5) ? "fill-yellow-500" : "text-gray-300"
                          }
                        />
                      ))}
                    </div>
              ...
              <form onSubmit={submitReview} className="mt-4 space-y-3">
                ...
                <button
                  ...
                  className="w-full px-4 py-2 bg-[#BEB9B1] text-white rounded-lg font-medium hover:opacity-90"
                >
                  {submittingReview
                    ? "Submitting..."
                    : user
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
            {related.map((p) => (
              <a
                ...
                className="group bg-white rounded-xl p-4 shadow hover:shadow-lg transition"
              >
                ...
                <div className="font-medium text-sm truncate group-hover:text-[#BEB9B1]">
                  {p.title}
                </div>
